          ...
          <div className="legionDangerHeaderAndImageContainer">
            <div className="legionDangerImageItemContainer">
              <div className="legionDangerImageContainer">
                <img src={LegionImage} alt="Skydas nuo legionelių" className="legionDangerImage"></img>
              </div>
            </div>
...
interface RightsAndObligationsLinkProps {
  onClick?: () => void;
}
export const RightsAndObligationsLink: React.FC<RightsAndObligationsLinkProps> = ({ onClick }) => {
  return(
    <>
      <Link className="legionLinkContainer" tabIndex={0} to="/teises-atsakomybes" onClick={onClick}>
...
export const ContactsLink: React.FC<ContactsLinkProps> = ({ onClick }) => {
  return(
    <>
      <Link className="legionLinkContainer" tabIndex={0} to="/kontaktai" onClick={onClick}>
        <div className="legionLinkTextContainer">
          <p>
